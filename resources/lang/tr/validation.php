...
return [
    ...
    */
    ...
    'has_appointment' => 'Belirtilen tarih aralığında randevunuz bulunmaktadır.',
    'has_passive_date' => 'Belirtilen tarih aralığında izinlisiniz.',
    ...
    */
    ...
    'attributes' => [
        'active' => 'Aktif',
        'address' => 'Adres',
        'address_link' => 'Konum Linki',
        'appointment_type_id' => 'Randevu tipi',
        'appointments' => 'Randevular',
        'appointments.*' => 'Randevu',
        'appointments.*.appointment_type_id' => 'Randevu tipi',
        'appointments.*.duration' => 'Randevu süresi',
        'appointments.*.start_date' => 'Randevu tarihi',
        'appointments.*.title' => 'Randevu başlığı',
        'avatar' => 'Avatar',
        ...
        'email' => 'E-posta adresi',
        'end_work' => 'Mesai bitiş saati',
        'fields' => 'Alanlar',
        'fields.*.field_id' => 'Alan',
        'fields.*.id' => 'Alan',
        'fields.*.value' => 'Değer',
        'gender' => 'Cinsiyet',
        'hospital_id' => 'Hastane',
        ...
        'price' => 'Fiyat',
        'products' => 'Ürünler',
        'products.*.count' => 'Ürün adedi',
        'products.*.price' => 'Ürün fiyatı',
        'products.*.product_id' => 'Ürün',
        'province_id' => 'Şehir',
        'resume' => 'Özgeçmiş',
        'services' => 'Hizmetler',
        'services.*.price' => 'Hizmet fiyatı',
        'services.*.service_id' => 'Hizmet',
        'slug' => 'SEO URL',
        'start_date' => 'Başlangıç tarihi',
        'start_work' => 'Mesai başlangıç saati',
        'stocks' => 'Stoklar',
        'stocks.*.hospital_id' => 'Hastane',
        'stocks.*.stock' => 'Stok',
        'surname' => 'Soyad',
        'title' => 'Ünvan',
        'total' => 'Toplam tutar',
